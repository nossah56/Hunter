...
GAME_MESSAGE = "⩹━★⊷━⌞ 𝑯𝑼𝑵𝑻𝑬𝑹| 𝑺𝑶𝑼𝑹𝑪𝑬 ⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب cr\n\n⩹━★⊷━⌞ 𝑯𝑼𝑵𝑻𝑬𝑹| 𝑺𝑶𝑼𝑹𝑪𝑬 ⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton (' M sasar', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ 𝑯𝑼𝑵𝑻𝑬𝑹| 𝑺𝑶𝑼𝑹𝑪𝑬 ⌝⚡️', url =f"https://t.me/huntersource")              
                 ],[
